...
$app->get("/boleto/:idorder", function($idorder){
	...
	$dadosboleto["cpf_cnpj"] = "12.345.678/0001-02";
	$dadosboleto["endereco"] = "Rua Um, 234 - Cinco, 678910-123";
	$dadosboleto["cidade_uf"] = "Citylandia - CL";
	$dadosboleto["cedente"] = "Ecommerce";
...
$app->post("/profile/change-password", function(){
	...
	//$user->setPassword($password);$_POST['new_pass']);
